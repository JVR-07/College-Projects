...
namespace P47_Metodo_Hash_Aritmetica_Modular
{
    internal class Program
    {
        ...
        public static int[] Hashing(int[] OriginalArray, int[] NewArray)
        {
            ...
            for (int i = 0; i < OriginalArray.Length; i++)
            {
                ...
                index = (OriginalArray[i] % OriginalArray.Length);
        ...
        {
            Console.Title = "P47 Método Hash Aritmética modular";

            //*********************************************************************************************************************************************************
            //Declaración de variables
            char option_menu;
            int matricula;
            int[] MatriculasArreglo = new int[35];
            int[] AuxMatriculasArreglo = new int[35];
            int IndexElement = 0;
