...
namespace Programa30_ClaseAbstracta_Perímetros
{
    internal class Program
    {
        abstract class Perimetros //Declaración clase abstracta
        {
            //Métodos de la clase abstracta
            public abstract float CalcularPerimetro();
            public abstract void DesplegarPerimetro(float resultado);
        }
        ...
        class Rombo : Perimetros //Declaración de clase derivada Rombo
        {
            ...
            public override void DesplegarPerimetro(float resultado)
            {
